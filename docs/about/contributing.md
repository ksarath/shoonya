...
title:  "Shoonya Contributor Guidelines"
---

Thank you for your interest in contributing to Shoonya.

_You too can contribute to Shoonya, we believe in you!_
...
After you [log into](https://github.com/login) GitHub using your account, go to the [Shoonya Project Page](https://github.com/ksarath/shoonya), and click on [Fork](https://github.com/ksarath/shoonya/fork) to fork the Shoonya repository into your own account.
...
mkdir shoonya
cd shoonya
git clone git@github.com:your-user-name/shoonya.git .
```

If these steps were successful, then congratulations, you now have a complete copy of the Shoonya project!
...
You may have your own idea about what contributions to make to Shoonya, which is great! If you want to make sure the Shoonya contributors are open to your idea, you can [open an issue](https://github.com/ksarath/shoonya/issues/new) first on the Shoonya project site.

Otherwise, if you have no ideas about what to contribute, you can find a large supply of feature requests and bugs on the project's [issue tracker](https://github.com/ksarath/shoonya/issues).

Issues are tagged with various labels, such as `good first issue`, which help you find issues that are a fit for you.

If some issue is confusing or you think you might need help, then just post a comment on the issue asking for help. Typically, the author of the issue will provide as much help as you need, and if the issue is critical, leading Shoonya contributors will probably step in to mentor you and give you a hand, making sure you understand the issue thoroughly.
...
Once you have an issue, the next step is to fix the bug or implement the feature. Since Shoonya is an open source project, there are no deadlines. Take your time!
...
```bash
git add path_to_new_file.scala
```
...
Now while you were working on this great improvement, it's quite likely that other Shoonya contributors were making their own improvements. You need to pull all those improvements into your own code base to resolve any conflicts and make sure the changes all work well together.

To do that, use the `git pull` command:

```bash
git pull git@github.com:ksarath/shoonya.git master
```
...
Next, [open a new pull request](https://github.com/ksarath/shoonya/compare) on GitHub, and select _Compare Across Forks_. On the right hand side, choose your own fork of the Shoonya repository, in which you've been making your contribution.
...
Once you have a pull request open, it's still your job to get it merged! To get it merged, you need at least one core Shoonya contributor to approve the code.
...
Once you receive a review, you will probably have to go back and make minor changes that improve your contribution and make it follow existing conventions in the code base. This is normal, even for experienced contributors, and the rigorous reviews help ensure Shoonya's code base stays high quality.
...
Sit back, relax, and enjoy being a Shoonya contributor!

# Shoonya Contributor License Agreement

Thank you for your interest in contributing to the Shoonya open source project.
